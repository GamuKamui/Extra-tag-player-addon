...
## ダウンロード [最新版v0.011](https://github.com/GamuKamui/Extra-tag-player-addon/releases/download/v0.010c/Extra-tag-player-addon-v0.010c.mcaddon).[改造用リソースパック.zip](https://github.com/GamuKamui/Extra-tag-player-addon/releases/download/v0.011/Extra-tag-player-addonR-v0.011.zip)
